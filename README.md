...
The `weblogic-buildpack` is a [Cloud Foundry][] buildpack for running JVM-based applications on WebLogic Application Server.  It is designed to run WebLogic-based applications with minimal configuration.
