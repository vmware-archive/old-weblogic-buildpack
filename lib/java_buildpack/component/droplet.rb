...
module JavaBuildpack::Component
  ...
  class Droplet
    ...
    def initialize(additional_libraries, component_id, java_home, java_opts, root)
      ...
      #puts "buildpack_root : #{buildpack_root}"
      #puts "sandbox_root : #{sandbox_root}"
      #puts "DROPLET-sandbox : #{@sandbox}"
      #puts "DROPLET-SandboxRoot : #{sandbox_root}"
      #puts "DROPLET-root : #{@root}"
      #puts "DROPLET-component_id : #{component_id}"
      #puts "DROPLET-javaOpts: #{@java_opts}"
      #puts "DROPLET-javaHome : #{java_home}"
